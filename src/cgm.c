...
void window_load_cgm(Window *window_cgm) {
  ...
  text_layer_set_text_color(tophalf_layer, GColorWhite);
  text_layer_set_background_color(tophalf_layer, GColorBlack);
  ...
  text_layer_set_text_color(calcraw_last1_layer, GColorWhite);
  ...
  text_layer_set_text_color(calcraw_last2_layer, GColorWhite);
  ...
  text_layer_set_text_color(calcraw_last3_layer, GColorWhite);
  ...
  bitmap_layer_set_background_color(cgmicon_layer, GColorBlack);
